    ...
    public: {
        ...
        steps: [
            ...
            },
            {
                ...
                description:
                    "A qualified doctor will be dispatched to the patient's location. The patient will receive an estimated arrival time, ensuring they know when to expect care. The doctor will arrive promptly and provide the necessary medical services in the comfort of the patient's home.",
            },
        ],
    },
    corporate: {
