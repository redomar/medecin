...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main
        className="flex-grow md:flex-col md:justify-center z-0 px-4"
        style={{
          background:
      ...
      >
        <motion.section
          className="grid grid-cols-1 gap-8 lg:grid-cols-2  mt-5 max-w-screen-xl  xl:justify-center justify-self-center"
          initial="hidden"
          animate="visible"
            ...
            <div className="w-full h-full px-20">
              <div className="bg-blue-800/85 text-white h-[460px] w-full p-2  gap-8 rounded-3xl flex flex-col justify-center items-center">
                ...
                <span className="max-w-md text-sm text-gray-50/80 text-center">
                  Our team of expert GPs is dedicated to your well-being. Start
                  your journey with Medecin A Domicile as corporate when toggled
                  to corporate and as individual when toggled to individual
                </span>
                <ActionButtons variant="" />
              </div>
            </div>
